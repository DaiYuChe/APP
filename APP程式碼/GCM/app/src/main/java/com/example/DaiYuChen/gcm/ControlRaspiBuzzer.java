...
/**
 * Created by DaiYuChen on 2016/11/2.
 */
import java.net.URI;
...
public class ControlRaspiBuzzer extends Activity {

    TextView tv1;

    private String uri = "http://203.72.0.26/~nhu1403/Python_controller.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_control_raspi_buzzer);
        setTitle("雲端推播(GCM)");
    ...
    //按鈕的Click事件
    public void CloseBuzzer(View view) {
        //產生新的HttpThread物件
        HttpThread myThread = new HttpThread();
        //設定變數值
        myThread.BuzzerState = "0000000";
        myThread.Url=uri.toString();
        //開始執行緒
        myThread.start();
    }
    ...
    class HttpThread extends Thread {
        ...
        //宣告變數並指定預設值
        public String BuzzerState = "NoData" ;
        public String Url = "http://203.72.0.26/~nhu1403/Python_controller.php";
        ...
        public void run() {
            ...
            try {
                ...
                //逐一增加POST所需的Key、值
                parmas.add(new BasicNameValuePair("BuzzerState",this.BuzzerState));
