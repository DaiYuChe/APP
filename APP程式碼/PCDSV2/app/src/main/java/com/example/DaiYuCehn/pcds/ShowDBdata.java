...
public class ShowDBdata extends Activity {

    static Activity showdbActivity;
    String use, pass;
   // ListView listView;
    private String url = "http://203.72.0.26/~nhu1403/APP_ShowData.php";
    TextView tv1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1 = (TextView) findViewById(R.id.DBtv);
    ...
    class HttpThread extends Thread {
        ...
        public String Url = "http://203.72.0.26/~nhu1403/APP_ShowData.php";
